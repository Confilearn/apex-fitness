    ...
    <div className="bg-bg">
      <section className="relative flex min-h-screen items-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img
            src="/assets/images/trainer-pullup.jpg"
            alt=""
        ...
        <div className="relative z-2 w-full max-w-full px-6 pt-28 pb-16 md:max-w-[760px] md:px-14 md:pt-32 md:pb-20">
          <div style={fd(0)} className="mb-5 flex items-center gap-3">
            <span className="block h-[1px] w-8 bg-accent-hi" />
          ...
          <h1 className="mb-[22px] font-body leading-none tracking-[-0.03em]">
            <div
              style={fd(70)}
              className="text-[clamp(38px,5.2vw,76px)] leading-none font-normal text-[rgba(232,224,208,0.82)]"
            >
              Looks Like You
            </div>
            <div style={fd(170)} className="text-[clamp(38px,5.2vw,76px)] leading-none">
          ...
          <div style={fd(400)} className="mb-14 flex flex-wrap items-center gap-x-8 gap-y-4">
            ...
            <button onClick={() => navigate('/get-started')} className="nav-link !text-[14px]">
          ...
          <div style={fd(520)}>
            <div className="mb-4 text-[11px] font-medium tracking-[0.2em] text-faint uppercase">
              Or Jump Straight To
            </div>
              ...
              {jumps.map((label) => (
                <button
                  ...
                  className="cursor-pointer rounded-full border border-[rgba(255,255,255,0.1)] bg-[rgba(255,255,255,0.05)]
                    ...
                    backdrop-blur-md transition-[border-color,color,transform] duration-200 ease-css"
                >
                  {label}
                </button>
              ))}
